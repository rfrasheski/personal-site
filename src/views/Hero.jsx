  ...
  <>
    <Divider speed={0.2} offset={offset}>
      ...
      <UpDownWide>
        ...
        <SVG icon="triangle" hiddenMobile width={12} stroke={colors.white} left="90%" top="50%" />
        ...
        <SVG icon="cross" hiddenMobile width={16} stroke={colors['pink-light']} left="28%" top="15%" />
      ...
      <SVG icon="hexa" hiddenMobile width={16} stroke={colors['grey-darker']} left="1%" top="50%" />
      <SVG icon="hexa" hiddenMobile width={8} stroke={colors['grey-darker']} left="80%" top="70%" />
    </Divider>
